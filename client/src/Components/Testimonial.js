...
const Testimonial = () => {
  return (
    <div id="testimonial" className="pt-5">
      <div className="work-section-wrapper">
        ...
        <div className="testimonials d-flex justify-content-center aligh-items-center">
          ...
          <div className="testimonial-section-bottom bg-light">
            <img src={ProfilePic} className="profile-image" alt="" />
            <p>
              " Thanks to Road Radar! Waiting for buses is a thing of the past.
              It is a lifesaver - it's like having a personal assistant for my
              daily traveling."
            </p>
            <div className="testimonials-stars-container">
              <AiFillStar />
          ...
          <div className="testimonial-section-bottom bg-light">
            <img src={ProfilePic} className="profile-image" alt="" />
            <p>
              " Efficiency at its best! It has truly transformed the way I
              travel, providing a hassle-free and punctual experience"
            </p>
            <div className="testimonials-stars-container">
              <AiFillStar />
              <AiFillStar />
